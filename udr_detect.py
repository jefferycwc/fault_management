...
def restart(instance_id):
    ...
    while 1:
        ...
        if count==25:
            break
    #client.connect('172.24.4.104', 22,username='ubuntu',password='',pkey=key,compress=True)
    #stdin,stdout,stderr = client.exec_command('cd /home/ubuntu/stage3;sudo nohup ./bin/udr & \n;exit')
    cmds=['cd /home/ubuntu/stage3\n','sudo nohup ./bin/udr & \n','exit\n']
    ssh_jump('172.24.4.104',cmds)
