...
class OpenStackAPI():
    ...
    def unpause_instance(self,instance_id):
        ...
        #print("resume ausf instance status: "+ str(res.status_code))
        #print(res)
        count=0
        while 1:
            if self.get_ausf_status(instance_id)=='ACTIVE':
                break
            time.sleep(1)
            count = count+1
            print('wait ' + str(count) + 's')
        print('unpause ausf successfully!!')
        #restart()
    ...
    def resume_instance(self,instance_id):
        ...
        while 1:
            ...
            count = count+1
            print('wait ' + str(count) + 's')
        print('resume ausf successfully!!')
        restart(instance_id)
    ...
    def reboot_instance(self,instance_id):
        ...
        while 1:
            ...
            count = count+1
            print('wait ' + str(count) + 's')
        print('reboot ausf successfully!!')
        restart(instance_id)
...
def restart(instance_id):
    ...
    #time.sleep(3)
    #test=OpenStackAPI()
    #status=test.get_ausf_status(instance_id)
    #while 1:
    #    print("the status is: {}".format(status))
    #    if status =='ACTIVE':
    #        break
    #    status=test.get_ausf_status()
    #time.sleep(10)
    print('resart ausf')
    count=0
    while 1:
    ...
    #stdin,stdout,stderr = client.exec_command('cd /home/ubuntu/stage3;sudo nohup ./bin/ausf & \n;exit')
    cmds=['cd /home/ubuntu/stage3\n','sudo nohup ./bin/ausf & \n','exit\n']
    ssh_jump('172.24.4.108',cmds)
    ...
    print('resart ausf successfully')
    return 
...
if __name__ == '__main__':
    ...
    while 1:
        test.ausf_detect()
    #test = OpenStackAPI()
    #instance_id = test.get_instance_id('free5gc-ausf-VNF')
    #restart(instance_id)
