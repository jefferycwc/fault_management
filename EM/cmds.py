...
upf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3/gtp5g\n','sudo make install\n','cd /home/ubuntu/stage3/src/upf/lib/libgtp5gnl/tools\n','sudo ./gtp5g-link del upfgtp0\n','sudo rm /dev/mqueue/*\n','cd /home/ubuntu/stage3/src/upf/build\n','sudo nohup ./bin/free5gc-upfd\n','exit\n']
nrf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/nrf & \n','exit\n']
amf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/amf & \n','exit\n']
smf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/smf & \n','exit\n']
udr_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/udr & \n','exit\n']
pcf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/pcf & \n','exit\n']
udm_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/udm & \n','exit\n']
nssf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/nssf & \n','exit\n']
ausf_list = ['sudo service VnfDetect start\n','cd /home/ubuntu/stage3\n','sudo nohup ./bin/ausf & \n','exit\n']
